...
const { jwtSecret, whitelist } = require("./config")
...
io.on("connection", function (socket) {
    socket.emit("message", "Hello from media recorder server!")
...
server.listen(1437, function () {
    console.log("https and websocket listening on *:", server.address().port)
})
